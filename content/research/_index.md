...
{{< research_section image="dendritic.svg">}}
...
{{< research_section image="sectors.svg">}}
...
# Peptide-Based Systems Chemistry and Nanomotors

Peptide assemblies provide a versatile platform for constructing dynamic and functional chemical systems. My research in this area focuses on cross-β amyloid nanostructures that combine molecular self-assembly with catalytic activity, reaction-network behaviour, and autonomous motion. By coupling peptide-based architectures with enzymes and multistep catalytic networks, these systems can convert chemical energy into  directed motility. This approach has enabled the development of fluorescent microswimmers and enzyme-powered nanomotors that respond to chemical gradients. These studies connect peptide self-assembly, systems chemistry, and active matter, and provide a route towards programmable microscopic machines with sensing, catalytic, and transport functions.

[Link to publications]({{< ref "publications/index.md#enzyme-powered-active-matter-and-peptide-assemblies" >}})
